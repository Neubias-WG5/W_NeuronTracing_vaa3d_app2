...
def main(argv):
    ...
    with BiaflowsJob.from_cli(argv) as nj:
        ...
        workflow(in_images, out_path,
                 nj.parameters.bkg_thresh, nj.parameters.b_256cube, nj.parameters.b_RadiusFrom2D,
                 nj.parameters.is_gsdt, nj.parameters.is_gap, nj.parameters.length_thresh,
                 nj.parameters.is_resample, nj.parameters.is_brightfield, nj.parameters.is_high_intensity)
        #if return_code != 0:
