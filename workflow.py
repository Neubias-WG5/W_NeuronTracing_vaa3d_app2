...
def workflow(in_images, out_path,
                 bkg_thresh, b_256cube, b_RadiusFrom2D,
                 is_gsdt , is_gap, length_thresh,
                 is_resample, is_brightfield, is_high_intensity):
    ...
    for neubias_input_image in in_images:
        ...
        command = "/usr/bin/xvfb-run Vaa3D_CentOS_64bit_v3.458/vaa3d -x libvn2 -f app2 -i {} -o {}.swc " \
                  "-p \"\" 0 {} {} {} {} {} {} {} {} {}".format(out_file_path, out_file_path[:-4],
                    bkg_thresh, b_256cube, b_RadiusFrom2D, is_gsdt, is_gap, length_thresh,
                     is_resample, is_brightfield, is_high_intensity)
